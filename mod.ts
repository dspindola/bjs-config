type Jsx = "react" | "react-jsx" | "solid" | "react-jsxDEV";
...
export interface BunConfiguration {
   ...
   */
  define?: ReturnType<typeof define>;
  /**
 ...
 * @version 0.0.1
 */
export function defineConfig<T extends BunConfiguration>(config: T): T {
  return config;
}
 ...
 * @version 0.0.1
 */
export function define<T extends object>(obj: T): T {
  return obj;
}
